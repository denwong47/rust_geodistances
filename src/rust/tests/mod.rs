...
/// traits.
///
/// These tests are somewhat barebone, as we have no third-party library to easily
/// match our results against. Those are to be done by ``pytest`` against `scikit-learn`
/// instead.
///
...
mod test_f64array_ops {
    ...
    fn __test_name__() {
        ...
        let ans = __array_type__::from_shape_vec(
            (3, 4),
            vec![
        ...
        let slice = __array_type__::from_shape_vec(
            (2, 2),
            vec![
...
mod test_distance {
    ...
    #[duplicate_item(
        __method__          __result__              __test_name__;
        [ Haversine ]       [_distance_haversine]   [ test_haversine_distance ];
        [ Vincenty ]        [_distance_vincenty]    [ test_vincenty_distance ];
    )]
    #[test]
    fn __test_name__() {
        ...
        let _distance_haversine = arr1(
         &[    0.             , 15355.972751566913 ,  2308.405072056323 ,
            2505.182173041389 , 10530.279544368199 , 17815.985603639052 ,
            6125.853456177508 , 11409.310093118786 ,  4715.271249265813 ,
           10087.844922193708 ,  6296.713095678412 , 11625.232181469633 ,
           15286.905528776377 ,  9443.61238939422  ,  1440.9193690362804,
           12904.05385420407  , 17691.747290369894 ,   299.1989936012719,
           13810.955353137253 ,  3385.6936118761114,  2319.7124723606366,
            5432.18238458127  , 11732.751975510415 ,  9618.70290735097  ,
            4023.300717013845 ,  4351.533043435921 ,  9017.48395687606  ,
           14873.108198861775 ,  6859.686447588234 , 16459.6742063208   ,
            6525.863412671655 ,  8416.73664634715  ]
        );

        let _distance_vincenty = arr1(
         &[    0.             , 15330.65723432854  ,  2316.2342133422994,
            2513.788893932584 , 10495.324717991085 , 17799.021492837113 ,
            6138.185163658037 , 11412.934362193526 ,  4732.718531861201 ,
           10070.010769827331 ,  6310.462295805489 , 11642.235675106655 ,
           15283.316157189649 ,  9415.825810395194 ,  1444.6234602194672,
           12909.783589221233 , 17679.50640022993  ,   299.9229894563173,
           13789.952654861501 ,  3397.3578895608025,  2323.761085633128 ,
            5452.032118069764 , 11721.266889296425 ,  9595.20947441337  ,
            4037.9120436598205,  4367.502351067549 ,  9015.673974925257 ,
           14856.965034280698 ,  6864.177714033012 , 16436.095148726854 ,
            6535.807440628501 ,  8440.226658173337 ]
        );
